  ...
  try {
    ...
    if (infoGrid) {
      infoGrid.innerHTML = `
        ...
        <div class="info-item"><label>Assigned Lawyer</label><div class="value link" onclick="window.location.href='client_casemanagement_advocate-profile.html?id=${currentCase.lawyer_id}'">${currentCase.lawyer_name || "Advocate Details"}</div></div>
