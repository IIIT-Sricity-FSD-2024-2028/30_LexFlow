...
export class UsersService {
  ...
  private seedIfEmpty() {
    ...
    const seed: User[] = [
      ...
      { id: 'user-1', fullName: 'Firm Admin', email: 'firmadmin@lexflow.test', role: UserRole.FIRMADMIN, createdAt: now, password: 'firmadminpass' },
      { id: 'user-2', fullName: 'Client Alice', email: 'alice@client.test', role: UserRole.CLIENT, createdAt: now, password: 'clientpass', phone: '+91-9000000001', addressLine1: '123 Client St', city: 'Bengaluru', state: 'Karnataka', pinCode: '560001' },
